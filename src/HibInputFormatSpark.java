 ...
 */
public class HibInputFormatSpark extends FileInputFormat<HipiImageHeader, ByteImage> {

    /**
     * Creates a {@link HibRecordReaderSpark}
     */
    @Override
    public RecordReader<HipiImageHeader, ByteImage> createRecordReader(InputSplit split,
                                                                       TaskAttemptContext context)
            throws IOException, InterruptedException {
        return new HibRecordReaderSpark();
    }
    ...
    public List<InputSplit> getSplits(JobContext job) throws IOException  {
        return org.hipi.imagebundle.mapreduce.HibInputFormat.computeSplits(job, listStatus(job));
    }
}
