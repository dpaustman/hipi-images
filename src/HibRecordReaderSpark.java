 ...
 */
public class HibRecordReaderSpark extends RecordReader<HipiImageHeader, ByteImage> {
    ...
    public void initialize(InputSplit split, TaskAttemptContext context)
        ...
        System.out.println("HibRecordReaderSpark#initialize: Input split starts at byte offset " + bundleSplit.getStart() +
    ...
    @Override
    public ByteImage getCurrentValue() throws IOException, InterruptedException  {
        return (ByteImage)reader.getCurrentValue();
    }
